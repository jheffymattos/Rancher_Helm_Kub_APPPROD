...
```sh
$ sudo docker run -d --privileged --restart=unless-stopped --net=host -v /etc/kubernetes:/etc/kubernetes -v /var/run:/var/run  rancher/rancher-agent:v2.6.2 --server https://rancher.kublabs.ml --token mkvb4lwlvm2q59rcbbmd8ks974p78wjbhbgg7sswz7d68cqppt78zp --ca-checksum de869e3ac6d6981c5953e0e69ef4b7ede7f4d2e3844ce6565161d8b4497ebb53 --node-name kub02 --etcd --controlplane --worker
```
